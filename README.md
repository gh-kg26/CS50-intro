...
Lispy Version 1.0.0.2
Hi, I am Kushagra from india and this is my version of Lisp, made with lot of smartwork
...
The standard library is a collection of custom functions written in Lispy that gets automatically loaded when you run the Lispy interface.
#### S-expressions
