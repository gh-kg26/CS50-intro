...
bool check_cycl(int winner, int loser);
...
void sort_pairs(void)
{
    ...
    {
        int index = i;
        int cur = preferences[pairs[i].winner][pairs[i].loser] - preferences[pairs[i].loser][pairs[i].winner];
...
void lock_pairs(void)
{
    ...
    for (int i = 0; i < pair_count; i++)
    {
        if (!check_cycl(pairs[i].winner, pairs[i].loser))
        {
